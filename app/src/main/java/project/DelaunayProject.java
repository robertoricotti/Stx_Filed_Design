...
public class DelaunayProject extends AppCompatActivity {
    ...
    Button btnCrs, btnDelaunay, btnLineRef, clear;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.delaunay_project);
    ...
    private void onClick(){
        btnPick.setOnClickListener((View v) -> {
            ...
            if(dataProject.getEpsgCode() == null)
                dataProject.setEpsgCode(EPSG_CODE,DelaunayProject.this);
        ...
        btnDelaunay.setOnClickListener((View v) -> {
